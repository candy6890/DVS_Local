...
namespace DVS
{
    public partial class Form1 : Form
    {
        ...
        void selectFirstStu_Data()  
        {
            ...
            sql += "FROM Student ";
            sql += "WHERE BranchID = '" + xStr + "' ";
            sql += "and year >= '" + System.DateTime.Now.AddYears(-7).ToString() + "' ";
            cmd = new SqlCommand(sql, conn);
            rd = cmd.ExecuteReader();
            while (rd.Read())
            {
        ...
        //-* A-3 *- 查詢學生資料 Stms-ClassIn_DV >> Local_ClassIn_DV
        ...
        private void deleteBtC_Click(object sender, EventArgs e)
        {
            ...
            //connetionString = "Data Source=" + System.Net.Dns.GetHostEntry("LocalHost").HostName.ToString() + ";Initial Catalog=STMS;User ID=sa;Password=";
            ...
            //string sql = null;
            //SqlDataReader rd;
            //connetionString = "Data Source=60.251.2.82;Initial Catalog=DVD;User ID=sa;Password=";
            //conn = new SqlConnection(connetionString);
            //conn.Open();
            //sql = "Insert into DVD_SwapSeatBak(xHost,xPeriod,xSeat,xID,xDate,xNot,xTime,xOutTime) VALUES (   ";
            //sql += "'" + xKey + "', ";
            //sql += "'" + xKey2 + "', ";
            //sql += "'" + xKey3 + "', ";
            //sql += "'" + xKey4 + "', ";
